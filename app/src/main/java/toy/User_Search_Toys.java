...
public class User_Search_Toys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_search_toys);
        ...
        search.setText("Search Key Word : "+searchQuery);
       ...
       listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(User_Search_Toys.this, User_View_Toy.class);
        ...
        BtnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (searchQuery.isEmpty()) {
                    ...
                    Intent intent = new Intent(User_Search_Toys.this, User_Search_Toys.class);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(User_Search_Toys.this, UserHome.class);
                intent.putExtra("UserInfo", account);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(User_Search_Toys.this, User_Cart.class);
                intent.putExtra("UserInfo", account);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(User_Search_Toys.this);
                ...
                alertDialog2.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(User_Search_Toys.this, LoginActivity.class);
                                startActivity(intent);
